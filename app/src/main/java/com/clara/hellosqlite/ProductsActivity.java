...
public class ProductsActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// T Set up Cursor, create ProductListAdapter using this Cursor,
		// T configure ListView to use this ProductListAdapter,
		...
		addProductButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				// TOO Request DB mananger add this product
		...
		searchProductsButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				//TOD request quantity of product from dbMananger
		...
		updateQuantityButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				//TOD: Ensure a product is selected and new quantity provided
				...
				// TOD dbMananger update product quantity
				...
				// TOD If update successful, show Toast and update ListView's Adapter's Cursor
			}
		});
		...
		allProductsListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view, int position, final long id) {
				...
				//TOD Show confirmation dialog. If user clicks OK, then delete item
